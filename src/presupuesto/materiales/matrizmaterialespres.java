...
public class matrizmaterialespres extends javax.swing.JDialog {
    ...
    public matrizmaterialespres(java.awt.Frame parent, boolean modal, Connection conex, String pres) {
        super(parent, modal);
        initComponents();
        this.pres = pres;
        this.conex= conex;
    ...
    public final void cargamats(){
        try {
            DefaultTableModel mmtabs = new DefaultTableModel(){@Override
             ...
             String sql="SELECT id, descri, precio, desperdi, unidad FROM mmpres WHERE mpre_id='"+pres+"' AND status=1";
