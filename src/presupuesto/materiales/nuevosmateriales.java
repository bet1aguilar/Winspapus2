...
public class nuevosmateriales extends javax.swing.JDialog {
    ...
    public nuevosmateriales(java.awt.Frame parent, boolean modal, Connection conex, String pres) {
        super(parent, modal);
        initComponents();
        this.pres = pres;
        this.conex = conex;
     ...
     public nuevosmateriales(java.awt.Frame parent, boolean modal, Connection conex, String pres, int edita, String codimate) {
        super(parent, modal);
        initComponents();
        this.pres = pres;
        this.conex = conex;
      ...
      public final void definemodelo(){
        String consulta = "SELECT id FROM mmpres WHERE mpre_id='"+pres+"' AND status=1";
        String [] mate;
        try {
     ...
     public final void cargardatos(){
        try {
            ...
            String consulta="SELECT id, descri, desperdi, precio, unidad FROM mmpres "
                    + "WHERE mpre_id='"+pres+"' AND id='"+codigomate+"' AND status=1";
    ...
    private void okButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_okButtonMouseClicked
        ...
        if(jTextField1.getText().toString().equals(""))
            ...
            try {
                Statement st = (Statement) conex.createStatement();
                String sql = "INSERT INTO mmpres VALUES ('"+pres+"', '"+jTextField1.getText().toString()+"'"
