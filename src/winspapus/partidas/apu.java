 ...
 * apu.java
 *
 * Created on 23/10/2012, 04:15:05 PM
 */
...
public class apu extends javax.swing.JDialog {
    ...
    public apu(java.awt.Frame parent, boolean modal, Connection conex, String mtabu, String num) {
        super(parent, modal);
        initComponents();
        this.conex = conex;      
        cadena = mtabu;
    ...
    public int getReturnStatus() {
     ...
     public final void buscamat(){
        float valor=0;
        contmat =0;
        System.out.println("cadena"+cadena+" num"+num);
        Statement part=null;
        try {
            part = (Statement) conex.createStatement();
     ...
     public boolean isCellEditable (int row, int column) {
        ...
        try {
            ...
            ResultSet rs1 = s1.executeQuery("SELECT mm.id, mm.descri, mm.precio, dm.cantidad, mm.unidad, mm.desperdi, (mm.desperdi*dm.cantidad*mm.precio) as total FROM mmtabs as mm, dmtabs as dm WHERE dm.mtabus_id='"+cadena+"' AND dm.numepart='"+num+"' AND dm.mmtab_id=mm.id AND dm.mtabus_id=mm.mtabus_id GROUP BY mm.id");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ánalisis de Precio Unitario");
        ...
        jLabel2.setText("Ingrese el Código para Agregar un Material");

        jLabel3.setText("Código:");

        jTextField1.setToolTipText("Ingrese el código del material");
        ...
        jButton4.setText("Imprimir APU");

        jLabel5.setText("Cantidad:");

        jLabel6.setText("Precio:");

        jLabel7.setText("Desperdicio");
        ...
        jTabbedPane1.addTab("Materiales", jPanel3);
        ...
        jLabel8.setText("Ingrese el Código para Agregar un Equipo");

        jLabel9.setText("Código:");

        jTextField6.setToolTipText("Ingrese el código del material");
        ...
        jLabel14.setText("Ingrese el Código para Agregar Mano de Obra");

        jLabel15.setText("Código:");

        jTextField11.setToolTipText("Ingrese el código del material");
        ...
        jButton12.setText("Imprimir APU");

        jLabel17.setText("Cantidad:");

        jLabel18.setText("Salario:");

        jLabel19.setText("Bono:");
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jTextField14, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel8, javax.swing.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)
                .addGap(47, 47, 47))
        );

        jTabbedPane1.addTab("Mano de Obra", jPanel5);
