 ...
 * @author Betmart
 */
public class equipospres extends javax.swing.JDialog {
...
String [] equipos, auxequipo;
 ...
 String descri, deprecia, precio, unidad; 
    private int cuantos;
    private String buscapres;
    /** Creates new form materiales */
    public equipospres(java.awt.Frame parent, boolean modal, String mpres, Connection conex, String mtabu, String num, String codicove) {
        super(parent, modal);
        initComponents();
        tabu = mtabu;
        this.mpres = mpres;
...
public final void cargarpres(){
      ...
      public final void cargarequipos(){
       ...
       public Class getColumnClass(int columna)
        ...
        try {
            Statement s = (Statement) conexion.createStatement();
            ResultSet rs = s.executeQuery("SELECT id,descri, deprecia, precio FROM Mepres WHERE mpre_id='"+buscapres+"'");
...
private void cambiarcabecera() {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jPanel10, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void closeDialog(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_closeDialog
     ...
     public void busca(){
       ...
       public Class getColumnClass(int columna)
        ...
        try {
            Statement s = (Statement) conexion.createStatement();
            ResultSet rs = s.executeQuery("SELECT id,descri, deprecia, precio FROM Mepres WHERE mpre_id='"+buscapres+"' AND (id LIKE'%"+busqueda+"%' || descri LIKE '%"+busqueda+"%')");
    ...
    private void okButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_okButtonMouseClicked
        ...
        for(int i=0; i<contsel;i++){
            ...
            try {
                String consulta = "SELECT descri, deprecia, precio FROM mepres WHERE id='"+equipos[i]+"' AND mpre_id='"+buscapres+"'";
