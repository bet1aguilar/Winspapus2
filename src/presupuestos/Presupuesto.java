...
public class Presupuesto extends javax.swing.JInternalFrame {
   ...
   DefaultTableModel mptabs;
    ...
    private void initComponents() {
        ...
        jButton13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/winspapus/imagenes/prorroga.fw.png"))); // NOI18N
        jButton13.setToolTipText("Prorroga");
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jButton6, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jButton24, javax.swing.GroupLayout.PREFERRED_SIZE, 30, Short.MAX_VALUE)
                    .addComponent(jButton3, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(0, 0, 0))
        );
        ...
        jButton4.setToolTipText("Añadir Partidas Seleccionadas");
        ...
        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 153, 153), 1, true), "Valores del Presupuesto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jTextField12, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 141, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(jPanel4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE))
                                .addGap(6, 6, 6)))
                        .addGap(5, 5, 5))
    ...
    public void buscapartida() throws SQLException{
        int cont=0;
        Statement st = (Statement) conex.createStatement();
        ResultSet rs = st.executeQuery("SELECT numero, numegrup, id, descri, tipo, idband "
       ...
       int idband = 0;
        ...
        ResultSet resultabus = tabus.executeQuery(mtabus);
            ...
            if(adicional==1){
                ...
                jTextField16.setText(mpre);
                
                System.out.println("Estoy entrando a adicional");
                this.setTitle("Gestionar Presupuesto de Obra: Seleccionada "+id+" Obra Adicional: "+mpre);
...
public void agrega(){
        ...
        String codicoves="";
            ...
            for(int i=0; i<contsel;i++){
                String sqlnumero = "SELECT numero FROM mppres where mpre_id='"+id+"' OR mpre_id IN (SELECT id from mpres where mpres_id ='"+id+"' GROUP BY id) ORDER BY numero DESC LIMIT 1";
                ...
                String selecciona = "SELECT descri, mbdat_id, rendimi, unidad, redondeo, status, mtabus_id "
                        + ", numero, codicove FROM mptabs where numero='"+partidas[i]+"' AND mtabus_id='"+tabu+"'";
                Statement stmt = (Statement) conex.createStatement();
                ...
                String existe = "SELECT count(id) FROM mppres WHERE id='"+codicoves+"' AND (mpre_id='"+id+"' "
...
//    agrega();        // TODO add your handling code here:
        ...
        if(jTextField15.getText().toString().equals("") || entrarafocus15==0){
           ...
           if(cont1>0){
               ...
               if(opi==JOptionPane.YES_OPTION){
                sql = "SELECT codicove, descri, unidad, precunit, precasu, redondeo, rendimi,status,mbdat_id, numero  FROM"
    ...
    private void jTextField20FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField20FocusLost
        ...
        if(jCheckBox1.isSelected()){
            ...
            select = "SELECT count(id) FROM mpres WHERE id='"+numpre+"'";
        ...
        try {
            ...
            String sqlnumero = "SELECT numero FROM mppres where mpre_id='"+auxid+"' OR mpre_id IN "
                    + "(SELECT id from mpres where mpres_id ='"+auxid+"' GROUP BY id) ORDER BY numero DESC LIMIT 1";
            ...
            String sqlnumegrup = "SELECT numegrup FROM mppres where mpre_id='"+auxid+"' "
                    + "OR mpre_id IN (SELECT id from mpres where mpres_id ='"+auxid+"' GROUP BY id) "
    ...
    private void jTextField14FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField14FocusLost
        ...
        if(jTextField14.getText().toString().equals("")|| entrarafocus15 == 0){
            ...
            if(op==0&&cont2==0&&contex!=0){
                sql = "SELECT codicove, descri, unidad, IFNULL(precunit,0.00), IFNULL(precasu,0.00), redondeo, rendimi,status,mbdat_id, numero  FROM"
        ...
        try {
            ...
            if(op==JOptionPane.YES_OPTION){
                ...
                unidad = jTextField17.getText();
                 ...
                 String actualiza = "UPDATE mppres SET descri='"+descri+"', unidad='"+unidad+"', "
                                 + "nropresupuesto='"+pres+"', tipo ='"+tipos+"', "
                         + "cantidad="+cantidad+" WHERE numegrup="+numegrup+" AND "
                                 + "(mpre_id='"+id+"' OR mpre_id IN (SELECT id FROM mpres WHERE mpres_id='"+id+"'))";
         ...
         campo.addKeyListener(new KeyAdapter()
{
   ...
   public void keyTyped(KeyEvent e)
   {
    ...
    public void calculapartida(String nume, String presupuesto, int edita){
        float auxcontotal;
        float admini=Float.valueOf(jTextField6.getText().toString());
        float utili=Float.valueOf(jTextField7.getText().toString());
        float financiero= Float.valueOf(jTextField8.getText().toString());
        float impuesto = Float.valueOf(jTextField9.getText().toString());
        float redondeado;
...
//*********************************************************************************    
        public void agregamano (int edita){
           ...
           float prestaciones = Float.valueOf(jTextField5.getText().toString());
        ...
        try {
            ...
            while(rst.next()){
               ...
               jTextField15.setText(rst.getString(9)); //codicove
                Statement inserta = (Statement) conex.createStatement();
               String sqlinsert;
               if(Float.valueOf(desperdi)!=0){
               valor += Float.valueOf(precio)* Float.valueOf(cantidad)* Float.valueOf(desperdi);
               }else
               {
                   valor += Float.valueOf(precio)* Float.valueOf(cantidad);
               }
