 ...
 * @author Betmart
 */
public class manopres extends javax.swing.JDialog {
...
String [] manos, auxequipo;
 ...
 String descri, salario, bono, unidad; 
    ...
    public manopres(java.awt.Frame parent, boolean modal, String mpres, Connection conex, String mtabu, String num, String codicove) {
        super(parent, modal);
        initComponents();
        tabu = mtabu;
        this.mpres = mpres;
...
public final void cargarpres(){
      ...
      public final void cargarmano(){
       ...
       public Class getColumnClass(int columna)
        ...
        try {
            Statement s = (Statement) conexion.createStatement();
            ResultSet rs = s.executeQuery("SELECT id,descri, salario, bono FROM Mmopres WHERE mpre_id='"+buscapres+"'");
            ...
            Logger.getLogger(manopres.class.getName()).log(Level.SEVERE, null, ex);
        }
...
private void cambiarcabecera() {
    ...
    private void closeDialog(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_closeDialog
     ...
     public void busca(){
       ...
       public Class getColumnClass(int columna)
        ...
        try {
            Statement s = (Statement) conexion.createStatement();
            ResultSet rs = s.executeQuery("SELECT id,descri, salario, bono FROM Mmopres WHERE mpre_id='"+buscapres+"' AND (id LIKE'%"+busqueda+"%' || descri LIKE '%"+busqueda+"%')");
    ...
    private void okButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_okButtonMouseClicked
        ...
        for(int i=0; i<contsel;i++){
            ...
            try {
                String consulta = "SELECT descri, salario, bono, subsid FROM mmopres WHERE id='"+manos[i]+"' AND mpre_id='"+buscapres+"'";
