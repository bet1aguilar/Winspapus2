...
public class materialespres extends javax.swing.JDialog {
...
String [] materiales, auxmat;
 ...
 String mpres, buscapres;
 String descri, desperdi, precio, unidad; 
    private int cuantos;
    /** Creates new form materiales */
    public materialespres(java.awt.Frame parent, boolean modal, String mpres, Connection conex, String mtabu, String num, String codicove) {
        super(parent, modal);
        initComponents();
        tabu = mtabu;
        this.mpres = mpres;
    ...
    public final void cargarpres(){
        try {
            ...
            int seleccionado=0;
                ...
                ResultSet rs = s.executeQuery("SELECT id FROM mpres WHERE status=1 AND mpres_id IS NULL");
               ...
               jComboBox1.setSelectedItem(mpres);
               buscapres=mpres;
        } catch (SQLException ex) {
            Logger.getLogger(materialespres.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
      public final void cargarmateriales(){
       ...
       public Class getColumnClass(int columna)
        ...
        try {
            Statement s = (Statement) conexion.createStatement();
            ResultSet rs = s.executeQuery("SELECT id,descri, desperdi, precio, unidad FROM Mmpres WHERE mpre_id='"+buscapres+"'");
...
private void cambiarcabecera() {
    ...
    private void closeDialog(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_closeDialog
     ...
     public void busca(){
       ...
       public Class getColumnClass(int columna)
        ...
        try {
            Statement s = (Statement) conexion.createStatement();
            ResultSet rs = s.executeQuery("SELECT id,descri, desperdi, precio, unidad FROM Mmpres WHERE mpre_id='"+buscapres+"' AND (id LIKE'%"+busqueda+"%' || descri LIKE '%"+busqueda+"%')");
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        buscapres=jComboBox1.getSelectedItem().toString();
        cargarmateriales();
    ...
    private void okButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_okButtonMouseClicked
        ...
        for(int i=0; i<contsel;i++){
            ...
            try {
                String consulta = "SELECT descri, desperdi, precio, unidad FROM mmpres WHERE id='"+materiales[i]+"' AND mpre_id='"+buscapres+"'";
                ...
                try {
                 ...
                 Statement cuenta = (Statement) conexion.createStatement();
                    ...
                    String sqlcuenta = "SELECT count(id) FROM mmpres WHERE mpre_id='"+buscapres+"' AND id='"+materiales[i] +"'";
